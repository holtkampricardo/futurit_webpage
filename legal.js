...
<br>
<p><strong>4. No contract</strong><br>
Registering on the waitlist does not create a purchase contract, employment, partnership, or obligation to provide the app or any compensation. We may modify, suspend, or cancel the project or waitlist at any time.</p>
<br>
...
We may update these Terms. Material changes will be published on this site. Continued use after publication constitutes acceptance where permitted by law.</p>
<br>
<p><strong>13. Severability</strong><br>
If any provision is invalid, the remainder remains in effect.</p>
<br>
...
<br>
<p><strong>2. Purposes and legal bases</strong><br>
| Purpose | Legal basis |<br>
| Waitlist management and launch communications | Consent (Art. 6(1)(a) GDPR) |<br>
| Promotional emails | Consent (optional checkbox) |<br>
| Security, abuse prevention, legal compliance | Legitimate interest / legal obligation |</p>
<br>
<p><strong>3. Formspree (processor)</strong><br>
We use <strong>Formspree, Inc.</strong> (USA) to receive form submissions. Formspree processes data on our instructions. Privacy policy: <a href="https://formspree.io/legal/privacy-policy/" target="_blank" rel="noopener noreferrer">formspree.io/legal/privacy-policy</a>. International transfers may occur; Formspree uses appropriate safeguards (e.g. Standard Contractual Clauses) as stated in their documentation.</p>
<br>
<p><strong>4. Other recipients</strong><br>
We do not sell or rent your data. Recipients may include: hosting/CDN providers, email tools (if you consented to marketing), and authorities when legally required.</p>
<br>
<p><strong>5. Retention</strong><br>
- Waitlist: until you withdraw consent, unsubscribe, or we delete the list, and in any case no longer than necessary (typically up to 24 months after last contact unless you object earlier).<br>
- Consent logs: retained as proof for the applicable statutory period (generally up to 5 years where relevant for accountability).</p>
<br>
...
Processing of personal data is described in our <span class="modal-link" data-type="privacy">Privacy Policy</span>.</p>
`
    },
    cookies: {
      title: "Cookie Policy",
...
<br>
<p><strong>1. Strictly necessary / technical</strong><br>
- <strong>futurit-lang</strong> (localStorage): remembers your language choice.<br>
- <strong>futurit-cookie-consent</strong> (localStorage): remembers whether you accepted or rejected non-essential processing.<br>
These are required for basic operation and do not require consent under ePrivacy rules.</p>
<br>
...
<br>
<p><strong>4. Sin contrato</strong><br>
Apuntarse a la lista no crea contrato de compra, laboral, societario ni obligación de entregar la app o compensación alguna. Podemos modificar, suspender o cancelar el proyecto o la lista en cualquier momento.</p>
<br>
<p><strong>5. Uso permitido</strong><br>
...
<br>
<p><strong>8. Exclusión de garantías</strong><br>
...
Podemos actualizar estos Términos. Los cambios relevantes se publicarán en esta web. El uso continuado implica aceptación cuando la ley lo permita.</p>
<br>
<p><strong>13. Nulidad parcial</strong><br>
Si alguna cláusula fuera inválida, el resto permanecerá vigente.</p>
<br>
<p><strong>14. Ley y jurisdicción</strong><br>
